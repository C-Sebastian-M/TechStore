// ─── EmailService — O + L ─────────────────────────────────────────────────────
// O: cerrado para modificación, abierto a extensión.
//    Para agregar un nuevo tipo de email se añade un método, no se modifica código existente.
...
export const EmailService = {
  ...
  // O: para agregar nuevos tipos de email se añaden nuevos métodos _buildXTemplate
  _buildVerificationTemplate(name, code) {
    return `
